...
{
    public partial class GiftsStorageForm : Form
    {
        /// <summary>
        /// 记录按扭标识
        /// </summary>
        ...
        public GiftsStorageForm()
        {
            editFlag = 0;
            InitializeComponent();
            this.dataGridView1.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(239, 243, 251);
        }
        //*******************************************************************
        /// <summary>
        /// 绑定画面
        ...
        private void BandingDgvCounter()
        {
            try
            {
                ...
                //绑定数据
                dataGridView1.DataSource = dtInput_storage;

                if (dataGridView1 != null && dataGridView1.Rows.Count > 0 && countNum != 0)
                {
                    dataGridView1.Rows[0].Selected = false;
                    dataGridView1.Rows[countNum].Selected = true;
                    dataGridView1.FirstDisplayedScrollingRowIndex = countNum;
                }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //绑定数据
                dataGridView1.DataSource = dtCondition;
        ...
        /// </history>
        //*******************************************************************
        private void GiftsStorageForm_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dataGridView1 != null && dataGridView1.SelectedRows.Count != 0)
            {
                ...
                //取得数据赋值文本框
                goods_code = dataGridView1.SelectedRows[0].Cells["input_goods_code"].Value.ToString();
                textBox_input_code2.Text = dataGridView1.SelectedRows[0].Cells["input_code"].Value.ToString();
                textBox_goods_name.Text = dataGridView1.SelectedRows[0].Cells["goods_name"].Value.ToString();
                textBox_input_arrival_count.Value =Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["input_arrival_count"].Value.ToString());
                textBox_counter_name.Text = dataGridView1.SelectedRows[0].Cells["counter_name"].Value.ToString();
                dataTime_input_maketime.Value = DateTime.Parse(dataGridView1.SelectedRows[0].Cells["input_maketime"].Value.ToString());
                dateTime_input_instorage_date.Value = DateTime.Parse(dataGridView1.SelectedRows[0].Cells["input_instorage_date"].Value.ToString());
                dateTime_input_checktime.Value = DateTime.Parse(dataGridView1.SelectedRows[0].Cells["input_checktime"].Value.ToString());
                textBox_supplier_name.Text = dataGridView1.SelectedRows[0].Cells["supplier_name"].Value.ToString();
                textBox_input_oper.Text = dataGridView1.SelectedRows[0].Cells["input_oper"].Value.ToString();
                textBox_input_quality_reg.Text = dataGridView1.SelectedRows[0].Cells["input_quality_reg"].Value.ToString();
                goods_code = dataGridView1.SelectedRows[0].Cells["input_goods_code"].Value.ToString();
                textBox_input_quality_persion.Text = dataGridView1.SelectedRows[0].Cells["input_quality_persion"].Value.ToString();
                textBox_input_remark.Text = dataGridView1.SelectedRows[0].Cells["input_remark"].Value.ToString();
                comboBox_packing_out.Text = dataGridView1.SelectedRows[0].Cells["input_packing_out"].Value.ToString();
                comboBox_packing_mid.Text = dataGridView1.SelectedRows[0].Cells["input_packing_mid"].Value.ToString();
                comboBox_packing_in.Text = dataGridView1.SelectedRows[0].Cells["input_packing_in"].Value.ToString();
                textBox_input_standard_count.Value =Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["input_standard_count"].Value.ToString());
                textBox_input_check_persion.Text = dataGridView1.SelectedRows[0].Cells["input_check_persion"].Value.ToString();
                textBox_input_issued.Text = dataGridView1.SelectedRows[0].Cells["input_issued"].Value.ToString();
                textBox_input_batch_num.Text = dataGridView1.SelectedRows[0].Cells["input_batch_num"].Value.ToString();
                textBox_quality_info.Text = dataGridView1.SelectedRows[0].Cells["quality_info"].Value.ToString();
                textBox_check_info.Text = dataGridView1.SelectedRows[0].Cells["check_info"].Value.ToString();
            }
            dataType = DataType.None;
            setButtonState();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            //获取原先数据和当前行号
            oldSTCount = Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["input_standard_count"].Value.ToString());
            countNum = dataGridView1.SelectedRows[0].Index;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("您确定要删除该数据吗？", this.Text, MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                //获得表的主健
                string input_code = dataGridView1.SelectedRows[0].Cells["input_code"].Value.ToString();
                //更新条件参数赋值
        ...
        private void btnCommit_Click(object sender, EventArgs e)
        {
            ...
            input_storageEntity.INPUT_TYPE = '2';
